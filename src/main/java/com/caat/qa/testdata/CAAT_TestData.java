...
public class CAAT_TestData {
	...
	public String Password = "CAA123";
	
	public String Add_FName = "Manoranjan";
	public String Add_LName = "Dubey";
	public String Address = "506, Sector1, CrossAsyst Limited";
	public String City = "Maryland";
	public String Select_State = "Alaska";
