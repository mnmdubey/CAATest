...
public class CAAT_ProfileAndTrans extends CAAT_TestBase{
...
//Page Factory - Object Repository
	...
	CAAT_TestData caat_TestData;
		...
		//Initializing the Page Objects:
			...
			public double validate_TransactionAmount(){
				OrderHistory.click();
				
				String Total_Price = TotalPrice.getText();
				Total_Price = Total_Price.replace("$", "");
				double Total_Amount = Double.parseDouble(Total_Price);
				return Total_Amount;
				}
